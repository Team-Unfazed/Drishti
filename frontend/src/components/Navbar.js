...
import { Shield, Home, Search, Phone, Info } from 'lucide-react';
...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { path: '/emergency', label: 'Emergency Call', icon: Phone },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center">
            ...
            <h1 className="text-xl font-bold text-gray-900">Crowd Shield</h1>
          </div>
